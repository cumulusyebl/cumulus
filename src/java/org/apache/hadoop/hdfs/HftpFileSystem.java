...
public class HftpFileSystem extends FileSystem {
  ...
  */
  ...
  public FSDataOutputStream create(Path f, long fileSize, FsPermission permission,
  		boolean overwrite, int bufferSize, Progressable progress) throws IOException {
	    throw new IOException("Not supported");
  }
