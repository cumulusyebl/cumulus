...
class BlockReceiver implements java.io.Closeable, FSConstants {
  ...
  private int receivePacket(long offsetInBlock, long seqno,
	...
	LOG.info("receivePacket, offsetInBlock: " +  offsetInBlock + ", seqno:" + seqno +", lastPacketInBlock: " + lastPacketInBlock 
			    + ", len: " + len +  ", endOfHeader: " + endOfHeader);
    // put in queue for pending acks
    if (responder != null) {
    	LOG.info("enqueue responder queue, lastPacketInBlock: " + lastPacketInBlock + ", offsetInBlock:" + offsetInBlock);
