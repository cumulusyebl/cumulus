...
public class NameNode implements NamenodeProtocols, FSConstants {
  ...
  */
   ...
   * {@inheritDac}
   */
  public CodingMatrix create(String src, long fileSize,
		  long packetSize,
		  FsPermission masked,
		  String clientName,
		  EnumSetWritable<CreateFlag> flag,
	  ...
	  CodingMatrix matrix = namesystem.startFile(src, fileSize, packetSize,
			  new PermissionStatus(UserGroupInformation.getCurrentUser().getShortUserName(),
					  null, masked),
  ...
  /** {@inheritDoc} */
  public boolean complete(String src, String clientName, Block[] blks)
      throws IOException {
    if(stateChangeLog.isDebugEnabled()) {
      stateChangeLog.debug("*DIR* NameNode.complete: "
          + src + " for " + clientName);
    }
    return namesystem.completeFile(src, clientName, blks);
  }
  ...
  @Override
  public LocatedBlocks getAllBlocksLocations(String src) throws IOException {
  	// TODO Auto-generated method stub
  	return namesystem.getAllBlocksLocationsInternal(src);
  }

  @Override
  public CodingMatrix getCodingMatrix(String src) throws UnresolvedLinkException {
  	// TODO Auto-generated method stub
  	return namesystem.getCodingMatrix(src);
  }
